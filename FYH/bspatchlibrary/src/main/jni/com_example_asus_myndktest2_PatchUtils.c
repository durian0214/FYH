...
#include "com_example_asus_myndktest2_PatchUtils.h"
...
/*
 * Class:     com_dongnaoedu_apkupdatemain_utils_PatchUtils
 * Method:    patch
 * Signature: (Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
 */
JNIEXPORT jint JNICALL
Java_com_example_asus_myndktest2_PatchUtils_patch(JNIEnv *env,
